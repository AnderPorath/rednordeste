...
export const mockUser: User = {
  ...
  description:
    "Profesional en administración de empresas con 5 años de experiencia en el sector comercial. Busco nuevas oportunidades de crecimiento profesional.",
  appliedJobs: ["1", "3"],
};
...
export const mockCompany: Company = {
  ...
  description:
    "Somos una empresa líder en desarrollo de software y soluciones tecnológicas en la región de Itapúa. Trabajamos con clientes locales e internacionales.",
...
export const mockApplications: Application[] = [
  ...
  },
  {
    ...
    userCity: "Hohenau",
    cvUrl: "/cv/pedro-lopez.pdf",
    message: "Soy especialista en redes sociales con portfolio comprobable.",
...
export function getJobsByCity(city: City): Job[] {
  return mockJobs.filter((job) => job.city === city);
}

export function searchJobs(keyword: string, city?: City, type?: JobType): Job[] {
